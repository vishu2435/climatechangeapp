...
// componentDidMount(){
//     console.log('Add model state is',this.props.src[0]['id'])
//     if(this.state.imageInView===null&&this.props.src.length===1){
//         let id=this.props.src[0]['id']
//         this.setState({
//             imageInView:id
//         },()=>{console.log("Add model state is ",this.state)})
//     }
// }
// componentDidUpdate(){
//     if(this.state.imageInView===null&&this.props.src.length==1){
